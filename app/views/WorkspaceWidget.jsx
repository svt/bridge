  ...
  return (
    <>
      ...
      <div className='View-component'>
        <WidgetRenderer widgetId={widgetId} widgets={repository} data={widget} onUpdate={data => handleComponentUpdate({ [id]: data })} forwardProps={{ isFloated: true, enableFloat: false }} />
      </div>
