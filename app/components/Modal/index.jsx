...
export function Modal ({ children, open, size = 'large', onClose = () => {}, onTransitionEnd, draggable = false, shade = true }) {
    ...
    <>
      {
        createPortal(
          (
            <div ref={elRef} className={`Modal Modal--${size} u-theme--light ${open ? 'is-open' : ''} ${draggable ? 'is-draggable' : ''} ${!shade ? 'has-noShade' : ''}`} onTransitionEnd={onTransitionEnd}>
