...
class Workspace extends EventEmitter {
  ...
  async createAccessToken (body) {
    return this.props.WorkspaceTokenManager.createAccessToken(this, body)
  }
  ...
  async setup (initialState) {
    ...
    this.socket = new SocketHandler(this, this.state)
    ...
    this.cleanupTask = setInterval(
      () => {
        this.api.connections.removeStaleConnections()
        this.emit('cleanup')
      },
...
DIController.main.register('WorkspaceRoot', Workspace, [
