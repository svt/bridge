 ...
 * @param { import('electron').BrowserWindowConstructorOptions | undefined } opts
 */
function initWorkspaceMainWindow (workspace, opts = {}) {
  const _opts = {
    width: 1280,
    height: 720,
    minWidth: 560,
  ...
  */
  window.on('close', async e => {
    ...
    */
     ...
     *
     * Therefore we're adding our own _close event
     *
  ...
  workspace.props.WindowStore.setMainWindow(window)
 ...
 * @param { import('electron').BrowserWindowConstructorOptions | undefined } opts
 */
function initStatelessWindow (url, opts = {}) {
  const _opts = {
    width: 1280,
    height: 720,
    minWidth: 320,
